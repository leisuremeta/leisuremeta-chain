...
// //   def find_Observer(observers: List[StateCase], find: Int) =
...
// //   // #1-observer-function
// //   def in_Observer_PageCase(observers: List[StateCase], find: Int = 0) =
// //     find_Observer(observers, find).pageCase

// //   def in_Observer_Number(observers: List[StateCase], find: Int = 0) =
