package io.leisuremeta.chain.lmscan.frontend.controllers.model.Pubs

import io.leisuremeta.chain.lmscan.common.model.*

case class PubCase_M1R1(
    block: PageResponse[BlockInfo] = new PageResponse[BlockInfo](0, 0, List()),
    // tx: PageResponse[TxInfo] = new PageResponse[TxInfo](0, 0, List()),
    // txDetail: PageResponse[BlockInfo] =
    //   new PageResponse[BlockInfo](0, 0, List()),
    // accountDetail: PageResponse[BlockInfo] =
    //   new PageResponse[BlockInfo](0, 0, List()),
    // nftDetail: PageResponse[BlockInfo] =
    //   new PageResponse[BlockInfo](0, 0, List()),
    // blockDetail: PageResponse[BlockInfo] =
    //   new PageResponse[BlockInfo](0, 0, List()),
    // None: PageResponse[BlockInfo] = new PageResponse[BlockInfo](0, 0, List()),
)
