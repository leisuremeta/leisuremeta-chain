  ...
  def view(model: Model): Html[Msg] =
    nav(`class` := "")(
      ...
      div(
        ...
        button(
          `class` := s"${PageCase.Observer().name == in_PageCase_Name(in_Observer_PageCase(model.appStates, model.curAppState))}",
      ...
      div(
        ...
        button(
          `class` := s"${PageCase.DashBoard().name == in_PageCase_Name(in_Observer_PageCase(model.appStates, model.curAppState))}",
      ...
      div(
        ...
        button(
          `class` := s"${PageCase.Blocks().name == in_PageCase_Name(in_Observer_PageCase(model.appStates, model.curAppState))}",
      ...
      div(
        ...
        button(
          `class` := s"${PageCase.Transactions().name == in_PageCase_Name(in_Observer_PageCase(model.appStates, model.curAppState))}",
