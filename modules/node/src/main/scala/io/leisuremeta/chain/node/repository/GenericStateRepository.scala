...
trait GenericStateRepository[F[_], K, V]:
  def get(
...
object GenericStateRepository:

  /** AccountState
    */
  trait AccountState[F[_]]:
    def name: GenericStateRepository[F, Account, AccountData]
    def key
        : GenericStateRepository[F, (Account, PublicKeySummary), PublicKeySummary.Info]
    def eth: GenericStateRepository[F, EthAddress, Account]
  object AccountState:
    ...
    given from[F[_]: Monad](using
      ...
      def name: GenericStateRepository[F, Account, AccountData] = fromStores
      def key: GenericStateRepository[
        F,
        (Account, PublicKeySummary),
        PublicKeySummary.Info,
      ] = fromStores
      def eth: GenericStateRepository[F, EthAddress, Account] = fromStores
  ...
  trait GroupState[F[_]]:
    def group: GenericStateRepository[F, GroupId, GroupData]
    def groupAccount: GenericStateRepository[F, (GroupId, Account), Unit]
  object GroupState:
    ...
    given from[F[_]: Monad](using
      ...
      def group: GenericStateRepository[F, GroupId, GroupData] = fromStores
      def groupAccount: GenericStateRepository[F, (GroupId, Account), Unit] =
        fromStores
  ...
  trait TokenState[F[_]]:
    def definition: GenericStateRepository[F, TokenDefinitionId, TokenDefinition]
    def fungibleBalance: GenericStateRepository[
      F,
      (Account, TokenDefinitionId, Hash.Value[TransactionWithResult]),
      Unit,
    ]
    def nftBalance: GenericStateRepository[
      F,
      (Account, TokenId, Hash.Value[TransactionWithResult]),
      Unit,
    ]
    def nft: GenericStateRepository[F, TokenId, NftState]
    def rarity: GenericStateRepository[F, (TokenDefinitionId, Rarity, TokenId), Unit]
    def entrustFungibleBalance: GenericStateRepository[
      F,
      (Account, Account, TokenDefinitionId, Hash.Value[TransactionWithResult]),
      Unit,
    ]
    def entrustNftBalance: GenericStateRepository[
      F,
  ...
  object TokenState:
    ...
    given from[F[_]: Monad](using
      ...
      def nft: GenericStateRepository[F, TokenId, NftState] = fromStores
      def rarity
          : GenericStateRepository[F, (TokenDefinitionId, Rarity, TokenId), Unit] =
        fromStores
      def entrustFungibleBalance: GenericStateRepository[
        F,
        (
  ...
  trait RewardState[F[_]]:
    def daoState: GenericStateRepository[F, GroupId, DaoInfo]
    def userActivityState: GenericStateRepository[F, (Instant, Account), DaoActivity]
    def tokenReceivedState: GenericStateRepository[F, (Instant, TokenId), DaoActivity]
  object RewardState:
    ...
    given from[F[_]: Monad](using
      ...
      def daoState: GenericStateRepository[F, GroupId, DaoInfo] = fromStores
      def userActivityState
          : GenericStateRepository[F, (Instant, Account), DaoActivity] = fromStores
      def tokenReceivedState
          : GenericStateRepository[F, (Instant, TokenId), DaoActivity] = fromStores
  ...
  given nodeStore[F[_]: Functor, K, V](using
      sr: GenericStateRepository[F, K, V],
  ...
  ): GenericStateRepository[F, K, V] = new GenericStateRepository[F, K, V]:
