...
class LocalGossipServiceInterpreter[F[_]
  : Async: Concurrent: StateRepository.AccountState.Name: StateRepository.AccountState.Key: StateRepository.GroupState.Group: StateRepository.GroupState.GroupAccount: TransactionRepository: BlockRepository](
