...
final case class NodeApp[F[_]
  : Async: BlockRepository: StateRepository.AccountState: StateRepository.GroupState: StateRepository.TokenState: StateRepository.DaoState: StateRepository.RandomOfferingState: TransactionRepository](
    config: NodeConfig,
):
